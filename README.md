...
To build the final jar and optimize the MarketingHandlerApplication application for production, run:
...
Then navigate to [http://localhost:3035](http://localhost:3035) in your browser.
